 ...
 * @since 1.0.0
 */
public interface SoftDeletableDbRepository<E extends SoftDeletableEntity>
    extends DbRepository<E>, SoftDeletableEntityRepository<E> {
   ...
   */
  @Override
  DbDeleteOperations<E> deletePhysical();
   ...
   */
  @Override
  DbFindOperations<E> findIncludingDeleted();
