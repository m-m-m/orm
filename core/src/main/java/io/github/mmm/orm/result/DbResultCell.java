 ...
 */
public interface DbResultCell<V> {
   ...
   * @return a new instance of {@link DbResultCell} with the same {@link #getSelection() selection} and
   *         {@link #getDbName() dbName} but the given {@code value} as {@link #getValue() value}.
   */
  DbResultCell<V> withValue(V newValue);
